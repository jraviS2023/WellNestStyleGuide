    ...
    return (
        <div className="content" style={{ justifyContent: 'center', alignItems: 'center' }}>
            ...
            <section id="icons" className="mt-10">
                ...
                <hr className="w-3/4" />
                <Box display="flex" justifyContent="center">
                    <Grid container spacing={1} style={{ maxWidth: '800px', marginTop: '20px' }}>
                        <Grid item xs={3}>
                            <IconCard iconUrl={'/Profile.png'} iconName={'Profile Icon'}></IconCard>
                        </Grid>
                        <Grid item xs={3}>
                            <IconCard iconUrl={'/DarthVader.png'} iconName={'Darth Vader'}></IconCard>
                        </Grid>
                        <Grid item xs={3}>
                            <IconCard iconUrl={'/Instagram.png'} iconName={'Instagram Logo'}></IconCard>
                        </Grid>
                        <Grid item xs={3}>
                            <IconCard iconUrl={'/Arrow.png'} iconName={'Dropdown Icon'}></IconCard>
                        </Grid>

                        <Grid item xs={3} style={{ marginTop: '20px' }}>
                            <IconCard iconUrl={'/Party.png'} iconName={'Party Icon'}></IconCard>
                        </Grid>
                        <Grid item xs={3} style={{ marginTop: '20px' }}>
                            <IconCard iconUrl={'/Draw.png'} iconName={'Pencil Icon'}></IconCard>
                        </Grid>
                        <Grid item xs={3} style={{ marginTop: '20px' }}>
                            <IconCard iconUrl={'/Whatsapp.png'} iconName={'Whatsapp Logo'}></IconCard>
                        </Grid>
                        <Grid item xs={3} style={{ marginTop: '20px' }}>
                            <IconCard iconUrl={'/Upload.png'} iconName={'Upload Icon'}></IconCard>
                        </Grid>
                    </Grid>
                </Box>
            </section>
